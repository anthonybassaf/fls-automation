...
//       // Example URL:
//       // https://speckle-stg.dar.com/projects/a45d92bf60/models/fec53bd78d
...
//       // 1. Update the backend .env file with the selected project/model IDs
